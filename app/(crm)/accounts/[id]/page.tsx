...
import { AccountHardwarePrefsEditor } from "@/components/accounts/account-hardware-prefs";
import { AccountDealHistory } from "@/components/accounts/account-deal-history";
...
export default async function AccountDetailPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <AccountHardwarePrefsEditor accountId={account.id} />
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <AccountEvidence accountId={account.id} />
        <AccountContacts accountId={account.id} />
      </div>
      <AccountDealHistory accountId={account.id} />
